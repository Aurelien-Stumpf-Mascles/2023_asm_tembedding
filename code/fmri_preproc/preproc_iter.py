...
def pipeline(low_pass,high_pass):

    outdir_path = "/neurospin/lbi/monkeyfmri/deepstim/workspace/2023_ASM_tembedding/gitproject/2023_asm_tembedding/data/TimeSeries/timeseries_{}_{}".format(high_pass,low_pass)
    ...
    for index, row in df.iterrows():
        ...
        dataset.append((fmri_file, confounds_file, outdir_path))
...
li_filtering = [[0.001,00]]

for i in range(len(li_filtering)):
    low_pass,high_pass = li_filtering[i]
    pipeline(low_pass,high_pass)
